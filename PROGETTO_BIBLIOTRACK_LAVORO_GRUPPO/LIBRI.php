...
<html>
    ...
    <header>
        ...
        <div class = form>
            ...
            <h1 id = dati_libro>Dati Autista</h1>
                </div>
...
if(isset($_POST["submit"])){
    ...
    $anno_pubblicazione = $_POST["pubblicazione"];
    ...
    $query = "INSERT INTO bibliotrack VALUES(0,'$titolo','$autore','$casa_editrice','$anno_pubblicazione','$collana','$genere')";
    $conn->query($query);
}
?>
